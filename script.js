...
const pullAgainBtn = document.getElementById('pull-again-btn');
...
const copyReadingBtn = document.getElementById('copy-reading');
const clearHistoryBtn = document.getElementById('clear-history');
const readMoreBtn = document.getElementById('read-more-btn');

if (pullCardBtn) pullCardBtn.addEventListener('click', pullCard);
if (pullAgainBtn) pullAgainBtn.addEventListener('click', pullCard);
if (cardElement) cardElement.addEventListener('click', flipCard);
if (pinterestShareBtn) pinterestShareBtn.addEventListener('click', shareOnPinterest);
if (copyCaptionBtn) copyCaptionBtn.addEventListener('click', copyTikTokCaption);
if (copyReadingBtn) copyReadingBtn.addEventListener('click', copyReading);
if (clearHistoryBtn) clearHistoryBtn.addEventListener('click', clearHistory);
if (readMoreBtn) readMoreBtn.addEventListener('click', openReadingLanding);
...
function openReadingLanding() {
    if (!currentCard) return;
    window.localStorage.setItem(selectedCardKey, JSON.stringify(currentCard));
